<x-app>
    <x-slot:title>
        {{ config('app.name') }} - Cadastrar fornecedor
    </x-slot>
    @push('styles')
        <style type="text/css">
            .customFocusedInput {
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="createVendorForm" action="{{ route('vendors.store') }}" class="row g-3" method="POST"
                            accept-charset="utf-8" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <h6 class="card-title fs-6">Dados do fornecedor</h6>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label for="cnpjInput" class="col-sm-2 col-form-label">CNPJ</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control cnpj_mask" id="cnpjInput" value="{{ old('cnpj') }}" name="cnpj" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="text-center">
                                    <x-forms.button-with-spinner id="createVendor" type="submit"
                                        class="btn btn-primary w-20" formId="createVendorForm">
                                        Cadastrar
