<x-app>
    <x-slot:title>
        {{ config('app.name') }} - Cadastrar usuário
    </x-slot>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-5">Cadastrar novo usuário</h5>
                            ...
                            accept-charset="utf-8" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="firstNameInput" name="first_name" value="{{ old('first_name') }}" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="lastNameInput" class="col-sm-2 col-form-label">Sobrenome</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lastNameInput" name="last_name" value="{{ old('last_name') }}" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="usernameInput" class="col-sm-2 col-form-label">Usuário</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="usernameInput" name="username" value="{{ old('username') }}" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="type"
                                                id="typeInput1" value="Administrador" {{ old('type') == 'Gerente' || old('type') == 'Entregador' ? '' : 'checked' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="type"
                                                id="typeInput2" value="Gerente" {{ old('type') == 'Gerente' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="type"
                                                id="typeInput3" value="Entregador" {{ old('type') == 'Entregador' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status"
                                                id="statusInput1" value="1" {{ old('status') == '0' ? '' : 'checked' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status"
                                                id="statusInput2" value="0" {{ old('status') == '0' ? 'checked' : '' }}>
